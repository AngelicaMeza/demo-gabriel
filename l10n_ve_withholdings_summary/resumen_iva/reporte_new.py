...
class WizardReport_1(models.TransientModel):  # aqui declaro las variables del wizar que se usaran para el filtro del pdf
    ...
    def print_resumen_iva(self):
        ...
        data = {
            'model': 'report.l10n_ve_withholdings_summary.libro_resumen_iva',
            'form': {
                #        'datas': datas,
        ...
        return self.env.ref('l10n_ve_withholdings_summary.libr_resumen_iva').report_action(self,
                                                                                   data=data)  # , config=False
       

class ReportResumenIva(models.AbstractModel):

    _name = 'report.l10n_ve_withholdings_summary.libro_resumen_iva'
