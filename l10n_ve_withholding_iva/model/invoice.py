...
class AccountMove(models.Model):
    ...
    def action_post(self):
        ...
        tax_use = self.line_ids.tax_ids.mapped('type_tax_use')
        list_purchase = [True if item == 'purchase' else False for item in tax_use]
        list_sale = [True if item == 'sale' else False for item in tax_use]

        # self.line_ids.tax_ids.type_tax_use == 'purchase'
        if all(list_purchase):
        ...
        # self.line_ids.tax_ids.type_tax_use == 'sale'
        elif all(list_sale):
