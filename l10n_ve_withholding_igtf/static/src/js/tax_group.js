odoo.define('l10n_ve_withholding_igtf.tax_group', require => {
	'use strict';
    ...
    var TaxGroupCustomField = AbstractField.extend({
        ...
        _isSaleDocument: function() {
        	return this.record.data.type === 'out_invoice' || this.record.data.type === 'out_refund';
        },

        _isInvoiceDocument: function() {
        	return this._isSaleDocument() || this._isPurchaseDocument();
        },
        ...
        _render: function () {
            ...
            var displayEditWidget = self._isInvoiceDocument() && this.record.data.state === 'draft' && this.getParent().mode === 'edit';
    ...
    fieldRegistry.add('tax-group-custom-field-sale-purchase', TaxGroupCustomField)
    return TaxGroupCustomField;
});