...
odoo.define("password_security.policy", function(require) {
    ...
    Policy.include({
         ...
         * @param {Number} [info.password_length_max=20]
        ...
        init: function(info) {
            ...
            this._password_length_max = info.password_length_max || 20;
        ...
        toString: function() {
            ...
            if (this._password_length_max <= 0) {
                if (this._password_length > 0) {
                    msgs.push(
                        _.str.sprintf(_t("al menos %d caracteres"), this._password_length)
                    );
                }
            }else {
                if (this._password_length > 0) {
                    msgs.push(
                        _.str.sprintf(_t("la contraseña debe tener entre %d y %d caracteres."), this._password_length, this._password_length_max)
                    );
                }
            ...
            if (this._password_lower > 0) {
                msgs.push(
                    _.str.sprintf(
                        _t("al menos %d caracteres en minúsculas"),
            ...
            if (this._password_upper > 0) {
                msgs.push(
                    _.str.sprintf(
                        _t("al menos %d caracteres en mayúsculas"),
            ...
            if (this._password_numeric > 0) {
                msgs.push(
                    _.str.sprintf(
                        _t("al menos %d caracteres numéricos"),
            ...
            if (this._password_special > 0) {
                msgs.push(
                    _.str.sprintf(
                        _t("al menos %d caracteres especiales"),
            ...
            msgs.push(
                _.str.sprintf(
                    _t("La contraseña no puede tener 3 caracteres repetidos sucesivamente"),
                    this._password_special
                )
            );
